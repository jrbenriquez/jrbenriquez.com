      ...
      <div class="flex justify-around">
        <div class="text-3xl text-center mt-10 text-gray-700">
          ...
          <p class="font-secondary font-thin my-8" data-aos="fade-down" data-aos-delay="1800" data-aos-duration="1000" data-aos-easing="ease-in-out">
            <span class="text-bold">I carry</span> sparkles of <span class="text-bold">VueJS</span>, <span class="text-bold">Flutter</span> and <span class="text-bold">React</span> if ever I need to bust it out in the <span class="text-bold">frontend</span>
          </p>
